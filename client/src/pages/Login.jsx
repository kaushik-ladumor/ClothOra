  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        localStorage.setItem("role", result.user.role); // ✅ Store role safely
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="relative">
                <Mail
                  className="absolute left-3 top-3 text-[#B3B3B3]"
                  size={18}
                />
                <input
                  type="email"
                  ...
                  placeholder="Email"
                  className={`w-full pl-10 pr-4 py-2 bg-[#1F1F1F] text-[#D4D4D4] rounded-md border ${
                    errors.email ? "border-red-500" : "border-[#B3B3B3]"
                  } focus:outline-none focus:ring-1 focus:ring-[#D4D4D4] placeholder-[#B3B3B3]`}
                />
              </div>
              {errors.email && (
            ...
            <div className="space-y-2">
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-10 py-2 bg-[#1F1F1F] text-[#D4D4D4] rounded-md border ${
                    errors.password ? "border-red-500" : "border-[#B3B3B3]"
                  } focus:outline-none focus:ring-1 focus:ring-[#D4D4D4] placeholder-[#B3B3B3]`}
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className={`w-full bg-[#D4D4D4] text-[#2B2B2B] font-medium py-2 rounded-md hover:bg-[#B3B3B3] transition-colors duration-200 flex items-center justify-center ${
            ...
            >
              {isLoading ? (
                <>
                  <svg
                    className="animate-spin -ml-1 mr-2 h-4 w-4 text-[#2B2B2B]"
